...
alter table users
add column date_1 DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
select 
count(id) as bd, 
date_format(date_format(birthday_at, '2020-%m-%d'), '%W') as day_of_the_week 
from users_users
